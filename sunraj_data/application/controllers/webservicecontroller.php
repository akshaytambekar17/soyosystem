<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	public class Webservicecontroller extends MY_Controller {
...
//start sendextendedtime created by mayuri  3/3/2017
	 	...
	 	function updateregistration()
		{
			...
			if($this->webservicemodel->checktoken($posttoken)==TRUE)
			{
				...
				if($this->webservicemodel->updateregistration($form_data)==true){
					
					$response['success'] = 1;
					$response['message'] = 'Successfully Updated Your Registration id';
					echo json_encode($response);   
				}
				else{
					$response['success'] = 0;
				...
				$response['success'] = 0;
				$response['message'] = 'Your token key is wrong';
				echo json_encode($response);         
			}
...
/******************* Firebase Code for sending notification *******************/
    ...
    private function sendPushNotification($fields) {
        ...
        $headers = array(
            'Authorization: key=AIzaSyBL_HImFN5dvCy3eg9z9kdkw4OA1AhJdaU',
...
/******************* End of Firebase Code for sending notification *******************/
