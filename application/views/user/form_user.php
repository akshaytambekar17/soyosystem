...
<body>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'text', 'name' => 'fname', 'class' => 'form-control form-group', 'placeholder' => 'First name', 'value' => !empty($user_details[0]->fname) ? $user_details[0]->fname : set_value('fname')]);
                                                    ?>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'text', 'name' => 'lname', 'class' => 'form-control form-group', 'placeholder' => 'Last name', 'value' => !empty($user_details[0]->lname) ? $user_details[0]->lname : set_value('lname')]);
                                                    ?>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'text', 'name' => 'mobile', 'class' => 'form-control form-group', 'placeholder' => 'Mobile Number', 'value' => !empty($user_details[0]->mobile) ? $user_details[0]->mobile : set_value('mobile')]);
                                                    ?>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'email', 'name' => 'email', 'class' => 'form-control form-group', 'placeholder' => 'Email', 'value' => !empty($user_details[0]->email) ? $user_details[0]->email : set_value('email')]);
                                                    ?>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'text', 'name' => 'adhar', 'class' => 'form-control form-group', 'pattern' => '[0-9]{12}', 'placeholder' => 'Aadhaar Number', 'value' => !empty($user_details[0]->adhar) ? $user_details[0]->adhar : set_value('adhar')]);
                                                    ?>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'text', 'name' => 'address', 'class' => 'form-control form-group', 'placeholder' => 'Address', 'value' => !empty($user_details[0]->address) ? $user_details[0]->address : set_value('address')]);
                                                    ?>
                                                </div>
                                                <div class="form-group">
    ...
    <?php echo $value['name']; ?>      
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'text', 'name' => 'city', 'class' => 'form-control form-group', 'placeholder' => 'City', 'value' => !empty($user_details[0]->city) ? $user_details[0]->city : set_value('city')]);
                                                    ?>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'text', 'name' => 'username', 'class' => 'form-control form-group', 'placeholder' => 'Username', 'value' => !empty($user_details[0]->username) ? $user_details[0]->username : set_value('username')]);
                                                    ?>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    echo form_input(['type' => 'password', 'name' => 'password', 'class' => 'form-control form-group', 'placeholder' => 'Password', 'value' => !empty($user_details[0]->password) ? $user_details[0]->password : set_value('password')]);
                                                    ?>
                                                </div>
                                                <div class="form-group">
